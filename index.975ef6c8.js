 ...
 */ parcelHelpers.export(exports, "getUrlSizePoster", ()=>getUrlSizePoster);
...
var _searchJs = require("./scripts/search.js");
"use strict";
// -------------KonradKonik
//ApiKey
const apiKey = "6bb894494c1a707618648b9164f393c2";
const AXIOS_AUTHORIZATION = "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2YmI4OTQ0OTRjMWE3MDc2MTg2NDhiOTE2NGYzOTNjMiIsInN1YiI6IjVlZDdiZmY3ZTRiNTc2MDAyMDM3NjYzZiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.kRGs0WRoomKwYXT7Mt8PNU2Zk6kAVasud5CyVVdf2mA";
//Axios header - api key
(0, _axiosDefault.default).defaults.headers.common["Authorization"] = AXIOS_AUTHORIZATION;
// Loader - klaudia
 ...
 */ function getMostPopularMovies(pageNumber) {
    if (pageNumber > 500) pageNumber = 500;
    showLoader(); // Wyświetlenie loadera przed wyszukaniem filmów
    getMostPopularMoviesTmdbApi(pageNumber).then((dataMovies)=>{
 ...
 */ function renderMovies(dataMovies) {
    ...
    const filmsList = dataMovies.results.map(({ id, title, poster_path, release_date, genre_ids })=>{
        //Img
    ...
    if (createPaginationNew) createPaginationNew(totalPages, currentPage, getMostPopularMovies);
}
/**
 *createPaginationNew
 ...
 */ function createPaginationNew(totalPages, page, callback) {
    ...
    if (page >= 1) {
        ...
        if (page === 1) paginationButtonLeft.disabled = true;
        else paginationButtonLeft.disabled = false;
        if (window.matchMedia("(min-width: 768px)").matches) {
            if (page > 3) {
                liTag += `<li class="pagination-new-numb" data-page="1"><span>1</span></li>`;
                if (page > 4) liTag += `<li class="pagination-new-dots">...</li>`;
            }
        }
        if (page == totalPages) beforePage = beforePage - 1;
        else if (page == totalPages - 1) beforePage;
        if (page == 1) afterPage = afterPage + 1;
        else if (page == 2) afterPage;
        ...
        if (window.matchMedia("(min-width: 768px)").matches) {
            if (page < totalPages - 2) {
                if (page < totalPages - 3) liTag += `<li class="pagination-new-dots">...</li>`;
        ...
        } else if (page === totalPages) paginationButtonRight.disabled = true;
        ...
        if (noEventListener) {
            paginationButtonLeft.addEventListener("click", (event)=>{
                const newPage = Number(event.currentTarget.getAttribute("data-page"));
                if (newPage >= 1) callback(newPage);
            });
            paginationButtonRight.addEventListener("click", (event)=>{
                const newPage = Number(event.currentTarget.getAttribute("data-page"));
                if (newPage <= totalPages) callback(newPage);
            });
 ...
 */ function getGenres(genre_ids) {
    ...
    const matchingGenres = genres.filter((genre)=>genre_ids.includes(genre.id)).map((genre)=>genre.name);
...
let lastSearchTerm;
if (search) search.addEventListener("submit", async (ev)=>{
    ev.preventDefault();
    cardsList.innerHTML = ` `;
    ...
    paginationButtons.style.display = "none";
    try {
        const data = await (0, _searchJs.searchMovies)(lastSearchTerm);
        const dataMovies = data.results;
        const genresList = await (0, _searchJs.fetchGenresList)();
        if (searchTerm === lastSearchTerm) {
            if (data.results.length === 0) warning.innerText = `Search result not successful. Enter the correct movie name and try again.`;
            else {
                (0, _searchJs.createCards)(dataMovies, genresList);
                paginationButtons.style.display = "none";
            }
        }
    } catch (error) {
...
document.body.addEventListener("click", async function(event) {
    if (event.target.classList.contains("card-img")) {
        ...
        try {
            ...
            const movieGenre = event.target.closest(".card").querySelector(".card-text-genre").textContent.split("|")[0].trim();
            const genreAndYear = event.target.closest(".card").querySelector(".card-text-genre").textContent;
    ...
    <span id="closeBtn" class="close">&times;</span>`;
            ...
            console.error("Wyst\u0105pi\u0142 b\u0142\u0105d podczas pobierania szczeg\xf3\u0142\xf3w filmu:", error);
        }
...
function addButtons(isWatched, isQueued) {
    ...
    if (isWatched) {
        if (isQueued) modalButtons.innerHTML = `
      ...
      `;
        else modalButtons.innerHTML = `
      <button id="removeFromWatchedBtn" class="modal-button modal-remove-button">REMOVE FROM WATCHED</button>
      <button id="addToQueueBtn" class="modal-button">ADD TO QUEUE</button>
      `;
    } else if (isQueued) modalButtons.innerHTML = `
...
},{"./sass/main.scss":"dFl68","axios":"jo6P5","./scripts/search.js":"DZomd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dFl68":[function() {},{}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utils.js":"5By4s","./http.js":"aFlee","./xhr.js":"ldm57","../core/AxiosError.js":"3u8Tl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fetch.js":"lVBFV"}],"ldm57":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("./../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"DZomd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// ----------------------------------------------------------------------------
...
async function fetchGenresList() {
    ...
    try {
        ...
        console.error("Wyst\u0105pi\u0142 b\u0142\u0105d podczas pobierania listy gatunk\xf3w:", error);
        throw error;
    }
}
async function searchMovies(searchTerm) {
    try {
        (0, _indexJs.showLoader)(); // Wyświetlenie loadera przed wyszukaniem filmów
        ...
        const response = await (0, _axiosDefault.default).get(url);
        (0, _indexJs.hideLoader)(); // Ukrycie loadera po otrzymaniu odpowiedzi
        return response.data;
    } catch (error) {
        (0, _indexJs.hideLoader)(); // Ukrycie loadera w przypadku błędu
        console.error("Wyst\u0105pi\u0142 b\u0142\u0105d podczas wyszukiwania:", error);
        throw error;
    }
}
function createCards(dataMovies, genresList) {
    ...
    dataMovies.forEach((element)=>{
        ...
        if (posterPath === null) {
            ...
            urlSizePoster = (0, _indexJs.getUrlSizePoster)(posterPath);
        ...
        genreIds.forEach((id)=>{
            ...
            else genreNames.push("Unknown");
        });
        // year
        const releaseDate = element.release_date;
        const d = new Date(releaseDate);
        let year;
        if (releaseDate === 0 || releaseDate === ``) year = ``;
...
},{"../index.js":"8lqZg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5"}]},["farZc","8lqZg"], "8lqZg", "parcelRequire4642")
