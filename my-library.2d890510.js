...
})({"e3dNj":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f0b43c5d2d890510";
"use strict";
...
},{}],"20JsE":[function(require,module,exports) {
// // owner: Marta Majnusz
...
//tworzenie kart w bibliotece - tu są zmiany
parcelHelpers.export(exports, "showLibrary", ()=>showLibrary);
...
function showLibrary(savedCards) {
    const gallery = document.querySelector(".cards-list");
    gallery.innerHTML = null;
    savedCards.forEach((el)=>{
        const card = document.createElement(`div`);
...
},{}]},["e3dNj","20JsE"], "20JsE", "parcelRequire4642")

//# sourceMappingURL=my-library.2d890510.js.map
